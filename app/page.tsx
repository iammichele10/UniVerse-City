        ...
        <div className="px-4 py-7 sm:px-6 sm:py-9">
          ...
          {lead && (
            <Link
              ...
              className="mb-8 grid gap-5 border-b border-rule pb-8 sm:grid-cols-2 sm:gap-8"
            >
              <div>
                <div className="mb-2 text-xs font-semibold tracking-wide text-brass">
                  {lead.category.toUpperCase()}
                </div>
                <h2 className="mb-3 font-serif text-2xl leading-tight text-ink sm:text-3xl">
                  {lead.title}
                </h2>
                <p className="mb-3 text-[15px] leading-relaxed text-[#484c46]">
                  {lead.excerpt}
                </p>
          ...
          <div className="grid gap-x-8 gap-y-5 sm:grid-cols-2 sm:gap-y-6">
            {rest.map((post) => (
              <Link
                ...
                className="flex gap-3 border-b border-rule pb-5 sm:gap-4"
              >
                {post.coverImageUrl && (
                ...
                <div className="min-w-0">
                  ...
                  <h3 className="mb-1.5 font-serif text-base leading-tight text-ink sm:text-lg">
                    {post.title}
                  </h3>
                  <div className="text-xs text-muted">
                    {post.authorName} ·{' '}
