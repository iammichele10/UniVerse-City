...
export function Masthead({ settings, currentCategory }: { settings: SiteSettings; currentCategory?: string }) {
  return (
    <header className="border-b-[3px] border-double border-ink px-4 pb-4 pt-6 text-center sm:px-6 sm:pt-8">
      <Link href="/" className="mx-auto mb-3 inline-block h-16 sm:h-20">
